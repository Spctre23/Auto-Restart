...
This repository expands on the [official TShock plugin template](https://github.com/TShockResources/AutoRestart) to include additional infrastructure for configuration files and chat commands.
